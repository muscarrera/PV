...
Public Class gDrawClass
    ...
    Public Sub DrawBl(ByRef e As System.Drawing.Printing.PrintPageEventArgs,
        ...
        If _Ttype.StartsWith("Tab") = False Then
            F_T = New Font(Form1.fontName_Normal_pt, Form1.fontSize_Normal_pt, FontStyle.Bold)
            F_D = New Font(Form1.fontName_Normal_pt, Form1.fontSize_Normal_pt)
        End If
        ...
        ElseIf _Ttype = "Table_2" Then '//////////////////////////////////////////////
            ...
            For Each c As gColClass In tc.details
                g.DrawString(c.HeaderName, F_T, Brushes.Black, New RectangleF(x, tc.y + 3, c.ColWidth - 3, 44), sf)
