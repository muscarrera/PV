...
Public Class Articles
        ...
        Try
            Using a As DataAccess = New DataAccess(My.Settings.ALMohassinDBConnectionString)
                ...
                For i As Integer = 0 To DGVPRD.SelectedRows.Count - 1
                    params.Clear()
                    params.Add("arid", DGVPRD.SelectedRows(i).Cells(0).Value)
                    a.DeleteRecords("article", params)
                Next
            End Using
    ...
    Private Sub txtsearch_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt.KeyUp
    ...
    Private Sub txtsearch_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt.KeyPress
