...
Public Class Form1
    ...
    Private Sub Button29_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button29.Click
        ...
        Dim dt1 As Date = Date.Parse(dte2.Text).AddDays(1) 'dte2.Value.AddDays(1)
        Dim dt2 As Date = Date.Parse(dte1.Text) '.AddHours(-12) dte1.Value.AddDays(-1)
            ...
            If txtArSearch.text <> "" Then
                ...
                ElseIf txtArSearch.text.Contains("|") Then
                    ...
                    Using a As DataAccess = New DataAccess(My.Settings.ALMohassinDBConnectionString)
                        ...
                        If cbAffichageLimite.Checked Then params.Add("writer = ", adminName)
