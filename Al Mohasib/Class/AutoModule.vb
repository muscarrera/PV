...
Module AutoModule
    ...
    Public Sub SaveDataToHtml_WithTotal(ByVal dg As DataGridView, ByVal nm As String, ByVal params As Dictionary(Of String, String))
        'create empty string
        ...
        the_html_file &= "<thead><tr>"
        'get tparams header
        For Each cc As KeyValuePair(Of String, String) In params

            the_html_file = the_html_file & "<th>" & cc.Key & "</th>"
        Next
        ...
        For Each cc As KeyValuePair(Of String, String) In params
            ...
            the_html_file = the_html_file & "<td>" & cc.Value & "</td>"
        Next
        the_html_file &= "</tr>"
        ...
        Dim fl = Path.Combine(Form1.ImgPah & "\output", nm & ".html")
        My.Computer.FileSystem.WriteAllText(fl, the_html_file, False)
    ...
    End Sub
    Public Sub SaveDataToHtml_WithTITLE(ByVal dg As DataGridView, ByVal nm As String, ByVal params As Dictionary(Of String, String))
        'create empty string
