Module ModuleCodeBar
    ...
    Function GetRandom(ByVal Min As Integer, ByVal Max As Integer) As String
        ' Add any initialization after the InitializeComponent() call.
        Dim str As String = Date.Now.ToString("ss") & Date.Now.ToString("yy")
        Dim Generator As System.Random = New System.Random()

        str &= CStr(Generator.Next(Min, Max))
        If str.Length <> 12 Then
            str &= Date.Now.ToString("dd") & Date.Now.ToString("hh")
